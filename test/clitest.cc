...
cli_option cli_options[] = {
  { 'a', 0, cli_option::flag, 1, &a, sizeof(a), "Test flag", 0 },
  { 0, "bb", cli_option::flag, 1, &b, sizeof(b), "Test flag", 0 },
  { 'c', 0, cli_option::string, 1, &c, sizeof(c), "Test string", 0 },
  { 0, "dd", cli_option::string, 1, &d, sizeof(d), "Test string", 0 },
  CLI_OPTION_END
};
